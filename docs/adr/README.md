...
| [0006](0006-stdio-only-transport-v1.md) | stdio-only transport in v1 | Accepted | 2026-09-18 |
| [0007](0007-polling-only-inbox-v1.md) | Polling-only inbox in v1 and the deletion-notification risk | Accepted | 2026-09-18 |
